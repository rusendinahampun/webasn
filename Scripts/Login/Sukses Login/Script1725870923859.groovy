...
WebUI.takeScreenshot('C:/Program Files (x86)/Katalon_Studio_Free_Windows_64-9.7.1/Capture/Login/Sukses Login/username.png')
...
WebUI.takeScreenshot('C:/Program Files (x86)/Katalon_Studio_Free_Windows_64-9.7.1/Capture/Login/Sukses Login/password.png')

//Klik button Masuk
//Save capture testing ke folder yang dituju (nama file harus format .png)
WebUI.click(findTestObject('Login Page/Masuk Button'))
WebUI.takeScreenshot('C:/Program Files (x86)/Katalon_Studio_Free_Windows_64-9.7.1/Capture/Login/Sukses Login/masuk dashboard.png')
